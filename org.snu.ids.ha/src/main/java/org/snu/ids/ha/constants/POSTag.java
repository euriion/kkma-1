...
public class POSTag
{
	...
	public static final long	MMT	= getTagNum("MMT");
	public static final long	MMN	= getTagNum("MMN");
	public static final long	MAG	= getTagNum("MAG");
	public static final long	MAJ	= getTagNum("MAJ");
	...
	public static final long	JKB	= getTagNum("JKB");
	public static final long	JKV	= getTagNum("JKV");
	...
	public static final long	EC	= getTagNum("EC");
	public static final long	ETN	= getTagNum("ETN");
	public static final long	ETM	= getTagNum("ETM");
	...
	public static final long	UA	= getTagNum("UA");
	...
	// 서술격 조사 '이다'를 제외한 용언
	public static final long	VP	= VV | VA | VX | VCN | XSV | XSA;
	// 지정사
	public static final long	VC	= VCN | VCP;
	// 용언
	public static final long	V	= VP | VCP;
	// 관형사
	public static final long	MM	= MMN | MMT;
	// 부사
	public static final long	MA	= MAG | MAJ;
	// 수식언
	public static final long	M	= MM | MA;
	// 격조사
	public static final long	JK	= JKS | JKC | JKG | JKO | JKB | JKV | JKQ;
	// 조사
	...
	// 전성형 어말 어미
	public static final long	ET	= ETN | ETM;
	// 어말 어미
	...
	// 접미사
	public static final long	XS	= XSN | XSV | XSA | XSM;
	// 외국어
	public static final long	O	= OL | OH | ON;
	// 기호
	public static final long	S	= SF | SP | SS | SE | SO | SW;
	// 기호, 외국어, 이모티콘
	public static final long	ETC = S | OL | OH | EMO;
	// 일반 조사 및 서술격 조사 '이다'
	public static final long	J_VCP = J | VCP;
